    ...
    public class SyncCommand
    {
        public async Task<int> InvokeAsync(string[] args)
        {
            try
            {
                ...
                {
                    Console.Error.WriteLine("Error: --local-path is required.");
                    ShowHelp();
                    return 1;
                }
                ...
                {
                    Console.Error.WriteLine("Error: --storage-zone is required.");
                    ShowHelp();
                    return 1;
                }
                ...
                {
                    Console.Error.WriteLine("Error: --access-key is required (or set BUNNY_ACCESS_KEY environment variable).");
                    ShowHelp();
                    return 1;
                }
                ...
                {
                    Console.Error.WriteLine("Error: --direction must be 'upload' or 'download'.");
                    ShowHelp();
                    return 1;
                }
        ...
        private SyncOptions ParseArguments(string[] args)
        {
            ...
            // Check environment variable for access key if not provided
            if (string.IsNullOrWhiteSpace(options.AccessKey))
            {
